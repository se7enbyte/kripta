...
public final class Crypto {
    ...
    public static byte[] decrypt(byte[] container, char[] passphrase, byte[] pepper) {
        ...
        // KDF parametreleri DERLEME SABITLERINDEN alinir; basliktaki mem/iter/par
        // AAD ile dogrulanir ama anahtar turetiminde KULLANILMAZ. Aksi halde
        // kurcalanmis bir baslik (devasa mem degeri) OutOfMemoryError'a / DoS'a
        // yol acar ve AAD dogrulamasi calismadan patlardi. Sabit kullanarak
        // kurcalanan baslik dogrudan GCM tag hatasina (SecurityException) doner.
        byte[] key = deriveKey(passphrase, salt, bound ? pepper : null,
                MEM_KIB, ITERATIONS, PARALLELISM);
        try {
            Cipher c = Cipher.getInstance("AES/GCM/NoPadding");
